		...
		<table cellpadding="5">
			...
			<tr>
				...
				<select class="easyui-combobox" name="stopDirection" data-options="method:'post',height:25, required:true,panelHeight:'auto'"
					style="width:300px;panelHeight:auto">
			...
			<tr>
				<td>站点类型:</td>
				<td>
					<select class="easyui-combobox" name="stopType"style="width:300px" data-options="method:'post',height:25, required:true,panelHeight:'auto'">
			...
			<tr>
				<td>所属省:</td>
				<td>
	            	<input id="stopProvince" name="stopProvince" class="easyui-combobox"
					data-options="method:'post',height:25, required:true"
					style="width: 97px" />
	            
	            	<input id="stopCity" name="stopCity"class="easyui-combobox"
					data-options="method:'post',height:25, required:true"
					style="width: 97px" />
	            
	            	<input id="stopArea" name="stopArea"class="easyui-combobox"
					data-options="method:'post',height:25, required:true"
					style="width: 97px" />
	            </td>
			</tr>
			...
			<tr>
				<!-- 隐藏域 应该动态获得 还没有解决这个问题-->
				<td style="width:150px;">
					<input name="stopId" type="hidden" value=""/>
					<input id="stopAreaid" name="stopAreaid" type=hidden value=""/>
					 <!-- <input id="stopCityid" name="stopCityid" type=hidden value=""/>
					<input id="stopProvinceid" name="stopProvinceid" type=hidden value=""/>  -->
				</td>
			</tr>
		</table>
	</form>
			...
			$('#stopCity').combobox({
				...
				onSelect : function(city) {
					$('#stopArea').combobox({
						...
						textField : 'area',
						editable : false,
						onSelect: function(areaId){
							
							console.log(areaId.areaId);
            				$("#stopAreaid").val(areaId.areaId);
        	}
					});
				}
			});
